...
def test_synthetic_data_forbidden():
    ...
    try:
        ...
        # Environment initialization might also fail if real data is enforced
        return True, f"Environment properly enforces real data: {e}"
...
def test_no_synthetic_patterns():
    ...
    for pattern in synthetic_patterns:
        if pattern in content:
            return False, f"Found synthetic pattern '{pattern}' in data!"
    
    return True, "No synthetic patterns found"
